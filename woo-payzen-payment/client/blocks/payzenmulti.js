...
const PAYMENT_METHOD_NAME = 'payzenmulti';
...
const Content = () => {
    ...
    jQuery('.wc-block-components-checkout-place-order-button').on('click', payzen_get_selected_option(['payzenmulti_option', 'payzenmulti_card_type']));
