...
class WC_Gateway_PayzenRegroupedOther extends WC_Gateway_PayzenStd
{
    ...
    public function init_form_fields()
    {
        ...
        $integration_mode_desc = '<br /><b>Embedded mode: </b>If you enable this option, the payment mean will be displayed in the embedded payment fields. Attention, not all available payment means are supported by the embedded payment. For more information, refer to the module documentation.';
